...
export const ru: Dictionary = {
  hero: {
    ...
    titleLine2: "HEAT.",
    description:
      "Премиальный консигнационный магазин стритвира и кроссовок. Покупайте, продавайте и обменивайте 100% аутентичные вещи.",
  ...
  catalog: {
    ...
    brandPageDesc: "Аутентичные дропы {brand} из SOLOVYEV STORE.",
  ...
  account: {
    ...
    phone: "Телефон",
    phonePlaceholder: "WhatsApp / мобильный",
  ...
  registerPromo: {
    ...
    cta: "СОЗДАТЬ АККАУНТ",
    close: "Закрыть",
    fab: "ПОЛУЧИТЬ СКИДКУ 15%",
    fabShort: "СКИДКА 15%",
    priceOffer: "СКИДКА 15%!",
  },
  footer: {
    ...
    tagline: "Премиальный консигнационный магазин стритвира и кроссовок.",
    rights: "Все права защищены.",
  },
  consent: {
    text: "Мы используем локальное хранилище для корзины. Продолжая, вы соглашаетесь с",
  ...
  about: {
    ...
    lead:
      "Премиальный консигнационный магазин стритвира и кроссовок — покупайте, продавайте и обменивайте 100% аутентичный огонь.",
    paragraphs: [
